  ...
  return (
    <section className="py-10 bg-transparent">
      <div className="container mx-auto px-44">
        ...
        {/* Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-slideIn pb-8">
          {/* Card 1 */}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-slideIn2'>
