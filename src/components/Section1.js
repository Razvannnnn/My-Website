...
import CV from '../documents/Razvan Mindrila_EN.pdf'
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-4 md:mb-8 px-3">
          {/* Name and Title Stacked Vertically */}
                ...
                <div className="flex space-x-3">
                  <a className='p-0' href={CV} target="_blank" rel="noopener noreferrer">
                  <button className="hover:scale-110 inline-flex h-12 items-center justify-center rounded-md border-2 border-neutral-800 px-2 font-medium text-white transition-transform duration-300 ease-in-out">
                    CV
                  </button>
                  </a>
                  <a className='p-0 md:pr-4'>
                  <button onClick={() => scrollToSection('section4')} className="hover:scale-110 inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-sky-500 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-2 font-medium text-white transition-transform duration-300 ease-in-out">
                    Contact me
                  </button>
                  </a>
                </div>
